...
div.style = "position: fixed;left: 0px;bottom: 0px;z-index: 1000000000;";
const input = document.createElement("input");
input.placeholder = "Name of PDF"
const button = document.createElement("button");
button.textContent = "Donwload";
button.onclick = function () {
    if (input.value === '' || !input.value)
        GooglePDFGenerator.startPDFGenerate();
    else
        GooglePDFGenerator.startPDFGenerate(input.value);
};
button.style = "background-color: #4CAF50;border: none;color: white;padding: 4px 13px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 10px;cursor: pointer;border-radius: 10px;";
